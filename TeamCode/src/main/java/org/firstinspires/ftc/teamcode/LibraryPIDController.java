...
public class LibraryPIDController
    {
         ...
         */
        public LibraryPIDController(double Kp, double Ki, double Kd)
        {
            m_P = Kp;
            m_I = Ki;
            m_D = Kd;
        ...
        /**
         * Set the setpoint for the LibraryPIDController
        ...
        /**
         * Returns the current setpoint of the LibraryPIDController
        ...
        /**
         * Begin running the LibraryPIDController
         */
        public void enable() {
            m_enabled = true;
        }
        ...
        /**
         * Stop running the LibraryPIDController.
         */
        public void disable() {
            m_enabled = false;
        }
